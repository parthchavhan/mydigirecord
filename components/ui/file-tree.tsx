    ...
    return (
      ...
      >
        <AccordionPrimitive.Trigger
          className={cn(
            `flex items-center gap-1 rounded-md text-sm w-full text-left py-1 px-2 hover:bg-muted/50 transition-colors`,
            className,
            {
  ...
  (
    ...
    return (
      <button
        ...
        disabled={!isSelectable}
        className={cn(
          "flex w-full items-center gap-1 rounded-md px-2 py-1 text-sm duration-200 ease-in-out hover:bg-muted/50 rtl:pr-0 rtl:pl-1",
          {
        ...
        {...props}
      >
        {fileIcon ?? <FileIcon className="size-4 text-blue-500" />}
